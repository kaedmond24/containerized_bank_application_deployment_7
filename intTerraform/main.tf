...
resource "aws_ecs_task_definition" "aws-ecs-task" {
  ...
  memory                   = "1024"
  cpu                      = "512"
  execution_role_arn       = "arn:aws:iam::063015932017:role/ecsTaskExecutionRolePolicy"
  task_role_arn            = "arn:aws:iam::063015932017:role/ecsTaskExecutionRolePolicy"

}

# ECS Service
resource "aws_ecs_service" "aws-ecs-service" {
  name                 = "bank-d7-ecs-service"
